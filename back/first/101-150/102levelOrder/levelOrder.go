...
func main() {
	...
	root.Left = &treenode.TreeNode{Val: 9}
	root.Right = &treenode.TreeNode{Val: 20}
	//root.Left.Left = &TreeNode{Val: 4}
	root.Right.Left = &treenode.TreeNode{Val: 15}
	root.Right.Right = &treenode.TreeNode{Val: 7}
	res := levelOrder(root)
...
func levelOrder(root *treenode.TreeNode) [][]int {
	...
	first := make([]*treenode.TreeNode, 0)
	second := make([]*treenode.TreeNode, 0)
