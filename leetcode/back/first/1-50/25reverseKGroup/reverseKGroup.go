...
// 反转以 a 为头结点的链表
func reverse(head, b *listnode.ListNode) *listnode.ListNode {
	var pre *listnode.ListNode
	var cur *listnode.ListNode
	var nxt *listnode.ListNode
...
*/
func reverseKGroupUseStack(head *listnode.ListNode, n int) *listnode.ListNode {
	res := new(listnode.ListNode)
	end := res.Next
	if head == nil {
		return head
	}
	...
	for curr != nil {
		...
		for len(stack) == n {
			...
			res.Next = &listnode.ListNode{Val: val}
...
func reverse2(head *listnode.ListNode) *listnode.ListNode {
